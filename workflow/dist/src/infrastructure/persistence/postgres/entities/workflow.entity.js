...
const workflow_1 = require("../../../../core/entities/workflow");
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], WorkflowEntity.prototype, "version", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
        enum: workflow_1.WorkflowStatus,
        default: workflow_1.WorkflowStatus.NOT_STARTED
    }),
    __metadata("design:type", String)
], WorkflowEntity.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => task_entity_1.TaskEntity, task => task.workflow, {
        cascade: true,
        eager: true
    }),
    __metadata("design:type", Array)
], WorkflowEntity.prototype, "tasks", void 0);
__decorate([
...
], WorkflowEntity.prototype, "metadata", void 0);
